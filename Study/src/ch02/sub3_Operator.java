...
public class sub3_Operator {
	...
	public static void main(String[] args) {
		...
		boolean res1 = var3 > 2 && var4 > 3;  // 앤드연산, 둘다 참 결과 참
		boolean res2 = var3 > 2 && var4 > 4;  // 앤드연산, 하나 거짓 결과 거짓
		boolean res3 = var3 > 2 || var4 > 4;  // 오어연산, 하나 참 하나 거짓 결과 참
		boolean res4 = var3 > 4 || var4 > 5;  // 오어연산, 둘다 거짓 결과 거짓
		boolean res5 = !(var3 > var4);        // 부정, 거짓에 낫 결과 참
